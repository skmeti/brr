		<div class="py-2 text-center flex-column bg-dark text-white">
			<h1 data-aos="zoom-in">Blue Adria Rent:</h1>
			<h2 data-aos="fade-up" data-aos-easing="ease" data-aos-delay="200">Boat Rentals, Excursions, Fishing & Adventure</h2>
		</div>

		<div class="row m-0 p-3 text-center" id="home-offer">
          <div data-aos="fade-left" class="col-lg-4 d-flex flex-column align-items-center">
            <img class="rounded-circle" src="/images/homepage/rent-a-boat.jpg" alt="Rent-A-Boat">
            <h2>Rent-a-Boat</h2>
            <p>Rent-a-Boat with or without a skipper. Our boats are fully equipped with everything necessary for a pleasant stay on the sea, as well as meeting all the standard requirements of our guests.</p>
            <p><a class="btn btn-secondary" href="#" role="button">Read more &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div data-aos="fade-up" class="col-lg-4 d-flex flex-column align-items-center">
            <img class="rounded-circle" src="/images/homepage/transfers-and-excursions.jpg" alt="Transfers and Excursions">
            <h2>Transfers & Excursions</h2>
            <p>Passenger transfer service with the possibility of choosing a vessel from our fleet. The transfer price depends on the starting point or destination. In addition, we organize one-day or half-day excursions with one of the ships from our fleet.</p>
            <p><a class="btn btn-secondary" href="#" role="button">Read more &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
          <div data-aos="fade-right" class="col-lg-4 d-flex flex-column align-items-center">
            <img class="rounded-circle" src="/images/homepage/fishing.jpg" alt="Fishing">
            <h2>Fishing</h2>
            <p>Blue Adria Rent also offers fishing excursions. At the request of the guest, we organize standard fishing trips or underwater fishing. We also obtain the necessary permits and fishing equipment.</p>
            <p><a class="btn btn-secondary" href="#" role="button">Read more &raquo;</a></p>
          </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
